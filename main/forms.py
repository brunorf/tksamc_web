...
class JobForm(forms.Form):
    ...
    temperature = forms.DecimalField(label='Temperature', max_digits=4, decimal_places=1, min_value=280, max_value=380, initial='300.0')
    tksamc_version = forms.ChoiceField(required=True, choices=[(1, "Classic TKSA-MC"), (2, "NTKSA-MC"), (0, "Both")])